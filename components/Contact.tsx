const links = [
  {
    label: 'Correo',
    href: 'mailto:v.milicfuentes@gmail.com',
    icon: (
      ...
      <div className="mt-6 flex flex-wrap gap-4 sm:mt-8 sm:gap-6">
        {links.map((link) => (
          <a
            ...
            className="flex items-center gap-1.5 text-xs font-medium text-gray-700 transition-colors hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 sm:gap-2 sm:text-sm"
          >
            {link.icon}
            {link.label}
          </a>
